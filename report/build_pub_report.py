...
<li><b>Honesty calibration.</b> Claims are significance-tested and the inconvenient findings are kept in the text — e.g., the bootstrap result (§8.1) that Convex Core is <i>not</i> statistically separable from the strongest balanced benchmark (40/60 SPY/IEF) on risk-adjusted ratios, and the validation (§12, §15) that the regime layer is a second-order refinement rather than the source of the edge.</li>
...
<tr><td style="text-align:left">"Why not just own 60/40?"</td><td style="text-align:left">✓ 60/40, 40/60, 80/20 all reported; on point estimates Convex improves on Sortino, Calmar, and full-period max drawdown, while the risk-adjusted gap vs 40/60 is not statistically separable (§9, §8.1).</td></tr>
